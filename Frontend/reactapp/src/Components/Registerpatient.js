...
function Registerpatient() {
  return (
    <div>
       ...
       <center><h1 style={{color:'white'}}>Register Patient</h1></center>
    </Row>
    ...
    <Row style={{marginTop:'30px'}}>
     ...
     <select style={{ width: '450px', marginLeft: '100px' , height:'35px'}}>
          ...
          <Col sm={6}>
        <h5 style={{marginLeft:'20px'}}>Blood Group</h5>
        <input type='text' style={{width:'450px',marginLeft:'20px'}}></input>
        </Col> 
    ...
    <center><Button style={{backgroundColor:'#870A30',marginTop:'30px',width:'200px',border:'none'}}>Register Patient</Button></center>
    </div>
  )
}
